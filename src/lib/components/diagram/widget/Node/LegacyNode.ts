...
import { EventManager, NodeAlignTranslationEvent } from '$lib/components/diagram/event';
...
class NodeState extends State<Node> {
	...
	override initState(context: BuildContext): void {
		...
		this.eventManager.addEventListener(NodeAlignTranslationEvent.type, this.handleAlignTranslation);
	}
